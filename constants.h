...
#define PLUG_ON      		0x6F6E 		//on
#define PLUG_OFF      	0x6F66 		//of
#define GET_DATA      	0x6764		//gd
#define ACTIVE_POWER  	0x70			//p
#define REACTIVE_POWER  0x71			//q
#define APPARENT_POWER  0x73			//s
#define U_RMS  					0x75			//u
#define I_RMS  					0x69			//i
